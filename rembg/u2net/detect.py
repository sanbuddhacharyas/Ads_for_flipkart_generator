...
def load_model(model_name: str = "u2net"):
    ...
    if model_name == "u2netp":
        ...
        net = u2net.U2NET(3, 1)
        path = "/home/san/Desktop/asmi/Ads_json_creator/rembg/u2net/weights/u2net.pth"
        # path = os.environ.get(
        #     "U2NET_PATH",
        #     os.path.expanduser(os.path.join("~", ".u2net", model_name + ".pth")),
        # )
        ...
        net = u2net.U2NET(3, 1)
        path = "/home/san/Desktop/asmi/Ads_json_creator/rembg/u2net/weights/u2net_human_seg.pth"
